...
.tab-row{display:flex;gap:8px;margin-bottom:10px;background:var(--bg2);border:1px solid var(--border);border-radius:999px;padding:4px;position:sticky;top:0;z-index:3;box-shadow:0 6px 18px rgba(15,23,42,.04)}.tab{flex:1;min-height:34px;padding:8px 12px;font-size:12px;font-weight:800;background:transparent;border:1px solid transparent;border-radius:999px;cursor:pointer;color:var(--t2);display:flex;align-items:center;justify-content:center;transition:background .18s ease,border-color .18s ease,color .18s ease,box-shadow .18s ease,transform .18s ease}.tab:hover{background:rgba(96,165,250,.08);border-color:rgba(96,165,250,.18);color:var(--t1);transform:translateY(-1px)}.tab.on{background:linear-gradient(180deg,var(--bg2),var(--bg3));color:var(--t1);border-color:var(--blue);box-shadow:0 8px 20px rgba(96,165,250,.16),inset 0 1px 0 rgba(255,255,255,.24);transform:translateY(-1px)}
