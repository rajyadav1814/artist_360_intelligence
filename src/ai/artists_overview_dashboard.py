...
.bars{display:flex;flex-direction:column;gap:9px;padding-top:2px}.bar-row{display:grid;grid-template-columns:18px minmax(104px,32%) minmax(0,1fr);gap:9px;align-items:center;min-height:18px}.bar-index,.bar-label{font-size:11px}.bar-index{color:var(--soft);text-align:center;font-variant-numeric:tabular-nums}.bar-label{color:var(--text);font-weight:800;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bar-track{height:18px;background:var(--track);border-radius:5px;position:relative;overflow:hidden}.bar-fill{display:block;height:100%;border-radius:5px;background:linear-gradient(90deg,var(--rose),var(--blue));border:1px solid rgba(251,113,133,.28);box-shadow:inset 0 1px 0 rgba(255,255,255,.18)}.bar-track b{position:absolute;right:6px;top:50%;transform:translateY(-50%);font-size:10px;color:var(--text);font-weight:900;text-shadow:0 1px 0 rgba(255,255,255,.22)}
