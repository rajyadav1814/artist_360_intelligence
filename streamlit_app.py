...
.tabs{display:flex;gap:8px;margin-bottom:1rem;padding-bottom:10px;border-bottom:1px solid var(--color-border-tertiary);overflow-x:auto}.tab{display:inline-flex;align-items:center;gap:7px;padding:7px 13px 7px 8px;font-size:13px;border:1px solid var(--color-border-tertiary);border-radius:999px;background:var(--color-background-primary);cursor:pointer;color:var(--color-text-secondary);white-space:nowrap;transition:background .15s ease,border-color .15s ease,color .15s ease}.tab .ico{width:22px;height:22px;border-radius:999px;background:var(--color-background-secondary);border:1px solid var(--color-border-tertiary);font-size:11px}.tab.active{color:var(--color-text-primary);font-weight:650;border-color:var(--accent);background:color-mix(in srgb,var(--accent) 10%,var(--color-background-primary))}.tab.active .ico{background:var(--accent);border-color:var(--accent);color:#fff}
