...
.tabs{display:flex;gap:4px;margin-bottom:1rem;border-bottom:1px solid var(--color-border-tertiary);overflow-x:auto}.tab{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;font-size:13px;border:none;background:transparent;cursor:pointer;color:var(--color-text-secondary);border-bottom:2px solid transparent;margin-bottom:-1px;white-space:nowrap}.tab.active{color:var(--color-text-primary);font-weight:650;border-bottom-color:var(--accent)}
